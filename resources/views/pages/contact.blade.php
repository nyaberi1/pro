        ...
        <div class="col-lg-4">
          <div class="contact-form-wrap">
            <div class="contact-form-box">
              <h4><i class="fas fa-map"></i> Pioneer University Address</h4>
              <p>PO Box 33421, Murangá road, <br>Opposite K.I.C.D, Nairobi<br> Kenya</p>
            </div>
            <div class="contact-form-box">
              <h4><i class="far fa-clock"></i> Working Hours</h4>
              <p>MON - FRIDAY: 8 to 5 PM <br> SAT : 10 to 8 PM </p>
            </div>
            <div class="contact-form-box">
              <h4><i class="fas fa-address-book"></i> Contact</h4>
              <p>Phone: 0700 372 354 <br> Phone: 0740 635 657<br> Email: info@piu.ac.ke
              </p>
            </div>
          </div>
        </div>
